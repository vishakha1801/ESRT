...
# This is a fixed version of train.py with improved forward_chop for scale=3
...
# FIXED forward_chop function for better handling of scale=3
...
for epoch in range(args.start_epoch, args.nEpochs + 1):
    ...
    # Comment out wandb usage as it might not be set up
    # run.log(metrics)
